...
const mockTours: Tour[] = [
  {
    ...
    is_featured: true,
    is_active: true,
    itinerary: [{ time: '09:00 AM', event: 'Pickup from hotel' }],
  ...
  },
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    slug: 'prison-island-adventure',
    title: 'Prison Island Adventure',
    description: 'Visit the Giant Aldabra Tortoises, some over 150 years old!',
    image: 'https://images.unsplash.com/photo-1606240724602-5b21f8963974?q=80&w=800',
    header_image: 'https://images.unsplash.com/photo-1606240724602-5b21f8963974?q=80&w=2670',
    price: 40,
    ...
    is_active: true,
    itinerary: [],
    inclusions: ['Boat transport', 'Snorkelling gear'],
    exclusions: ['Lunch'],
  },
  {
    id: '5',
    ...
    header_image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?q=80&w=2670',
    price: 35,
    price_display: 'From $35',
    duration: '3 Hours',
    group_type: 'Private Tour',
    group_size: '1-10 guests',
    location: 'Zanzibar Spice Farms',
    category: 'Culture',
    is_safari: false,
    is_featured: false,
    is_active: false,
    itinerary: [],
    inclusions: ['Guide', 'Spice samples'],
